...
// TestReserve_AutoRecoversExpiredLease confirms that a job whose lease has
// expired is returned by a subsequent Reserve call.
func TestReserve_AutoRecoversExpiredLease(t *testing.T) {
	t.Parallel()
